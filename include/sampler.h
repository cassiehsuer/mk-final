...
class Sampler
{
    ...
    uniform_int_distribution<int> mod_q_boot_sampler;

    public:
        Sampler(Param _param): param(_param)
        {
            mod_q_base_sampler = uniform_int_distribution<int>(-param.half_q_base, param.half_q_base);
            mod_q_boot_sampler = uniform_int_distribution<int>(-half_q_boot, half_q_boot);
        }

        void get_ternary_hwt_vector(vector<int>& vec, int h);
        ...
        void get_uniform_vector_boot(vector<int>& vec);


        void get_uniform_vector_with_neg(vector<int>& vec, vector<int>& vec_neg);
        ...
        void get_uniform_matrix_boot(vector<vector<int>>& mat);

        void get_uniform_matrix_with_neg(vector<vector<int>>& mat, vector<vector<int>>& mat_neg);
